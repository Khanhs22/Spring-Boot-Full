...
//			deleteCourse(appDAO);
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		Course tempCourse2 = new Course("Learning Chinese");
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		...
		Course tempCourse = new Course("Learning Web Java");

		Student tempStudent1 = new Student("Khanh", "Nguyen", "khanh@g.com");
		Student tempStudent2 = new Student("John", "Tran", "john@g.com");

		tempCourse.addStudent(tempStudent1);
		tempCourse.addStudent(tempStudent2);

		System.out.println("Saving the course: " + tempCourse);
		System.out.println("acssociated stidents: " + tempCourse.getStudents());
